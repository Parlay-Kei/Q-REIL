...
| GitHub repo q-reil | github-admin | Done | https://github.com/AspireNexis/q-reil |
...
**Remaining:** In Vercel [q-reil Settings](https://vercel.com/strata-nobles-projects/q-reil/settings) → connect Git repo **AspireNexis/q-reil** for auto-deploys from main.
