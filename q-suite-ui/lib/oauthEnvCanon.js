/**
 * Gmail OAuth env canon for q-suite-ui (Vercel serverless). Same contract as connectors/gmail/lib/oauthEnvCanon.js.
 * Contract: docs/reil-core/OAUTH_ENV_CANON.md. Mission: PLATOPS-REIL-OAUTH-ENV-CANON-IMPLEMENT-0018.
 *
 * getGmailOAuthEnv(envSource?) reads canonical keys first, falls back to legacy aliases, returns
 * normalized object with canonical key names only and a "missing" list.
 */
 ...
 * @returns {{ env: Record<string, string>, missing: string[], source?: Record<string, 'canonical'|'alias'> }}
 */
